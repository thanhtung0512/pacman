...
def pacphysicsAxioms(
    ...
    potential_pacman_locations = [
        PropSymbolExpr(pacman_str, loc[0], loc[1], time=t)
        for loc in non_outer_wall_coords
    ]
    ...
    potential_actions = [
        PropSymbolExpr(action_str, time=t) for action_str in DIRECTIONS
    ]
